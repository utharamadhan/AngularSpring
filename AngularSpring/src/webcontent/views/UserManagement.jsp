...
<html>
  <head>  
    ...
    <style>
     ...
     <link href="<c:url value='/vendor/css/bootstrap.css' />" rel="stylesheet"></link>
     <link href="<c:url value='/vendor/css/app.css' />" rel="stylesheet"></link>
  </head>
  <body ng-app="myApp" class="ng-cloak">
      ...
      <script src="vendor/angular.min.js/angular.js"></script>
      <script src="<c:url value='/core/app.js' />"></script>
      <script src="<c:url value='/service/userService.js' />"></script>
      <script src="<c:url value='/controller/userController.js' />"></script>
  </body>
</html>